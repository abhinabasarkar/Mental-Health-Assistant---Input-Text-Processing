...
while num_of_folds < 5:
	...
	for i in range(start,start+total_size/5):
		token_test_list.append(L[i].strip('\n'))
		label_test_list.append(L2[i].strip('\n'))
		tL.append(i)
